...
| --- | --- | --- | --- |
| RS-1 | Loading do resumo | `GET /laws/{id}` principal retorna a lei e a consulta do resumo permanece pendente. | O card exibe indicador local "Gerando resumo explicativo..." e o texto da lei permanece visível. |
